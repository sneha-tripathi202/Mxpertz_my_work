...
const About = () => {
  return (
    <div className='w-full h-90 sm:h-140 md:h-185 bg-(--pink) flex items-center justify-center'>
      <div className='flex  flex-col items-center justify-center'>
        ...
        <div>
            <input className='p-2 pl-10 rounded-full bg-white h-14 sm:w-110 w-40vw md:w-144 xl:w-172   sm:h-18 m-6 placeholder:text-[#363636] placeholder:font-medium placeholder:ml-2' type="text" placeholder=' Your email address....' />
