    ...
    <div>
       <div className='bg-white  mt-20  xl:w-99 lg:w-75 lg:h-110 xl:h-135 md:w-60 md:h-100 rounded-3xl text-center '>
                        ...
                        <div className='flex flex-col  items-center justify-center'> 
                          <h1 className=' xl:mb-4  xl:p-8 xl:w-85   lg:p-8 lg:w-85  font-medium text-center  md:p-2 text-(--blue2)  lg:text-xl'>{des}</h1>
                          ...
                          <button className='bg-(--pink) text-[#FFFFFF] xl:text-xl xl:p-3  lg:p-2 md:p-1 md:w-20 md:m-3 lg:w-30 lg:m-3 xl:w-35 rounded-4xl'>Read me</button></div>
                      </div>
    </div>
  )
}
