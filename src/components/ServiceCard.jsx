...
const ServiceCard = () => {
    return (
        <div className='bg-[#F5F5F5] h-220 w-full md:h-250 sm:h-220 lg:h-211   '>
            ...
            <div className='flex  w-full relative top-34 justify-around flex-wrap scroll  p-2'>
                ...
                <div className='bg-(--white) ml-3 shadow mousedown md:w-70 mt-15 flex flex-col items-center justify-center rounded-xl text-center '> 
                ...
                <div className='bg-(--white) mr-1 ml-3 shadow mousedown  md:w-70 mt-15 flex flex-col items-center justify-center rounded-xl text-center '> 
