    ...
    return (
        <div className='bg-[#F5F5F5] h-211 w-screen  '>
            ...
            <div className='flex w-full relative top-34 justify-around p-2'>
                <div className='bg-(--white) mt-15 md:w-70 md:h-98 flex flex-col ml-1 items-center justify-center rounded-xl text-center '>
                ...
                <div className='bg-(--white) mr-1 ml-3  md:w-70 mt-15 flex flex-col items-center justify-center rounded-xl text-center '> 
                  <div className=' lg:w-15  text-  lg:h-15 md:w-12 mt-6 h-12 rounded-2xl bg-(--pink)  flex justify-center items-center'><LuFileSpreadsheet size={32} color='white'/></div>
                    ...
                    <button className='bg-(--pink)  relative top-36 rounded-full  text-(--white) w-54 text-[20px] font-semibold p-1 md:p-4 m-10 text-center xl:ml-160 lg:ml-105 '>  Read More</button>
        </div>
    )
}
